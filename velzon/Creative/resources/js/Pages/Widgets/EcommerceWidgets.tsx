                ...
                <Col xl={3} ms={6}>
                    <Card className="card-height-100">
                        <Card.Body>
                            ...
                            <Link href="#" className="btn btn-soft-secondary d-block">Add to Cart</Link>
                            ...
                            <div className="notification-elem" id="notification-overlay">
                                <div className="text-center">
                                    ...
                                    <div className="mt-4 pt-2">
                                        ...
                                        <div>
                                            <button type="button" className="btn btn-secondary btn-sm w-sm" id="back-btn" onClick={backToHome}>Back to Home</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
