                            ...
                            <Card className="plan-box mb-0">
                                <Card.Body className="p-4 m-2">
                                    ...
                                    <div className="py-4 text-center">
                                        {plan ? <h1 className="month"><sup><small>$</small></sup><span className="ff-secondary fw-semibold">19</span> <span
                                            className="fs-13 text-muted">/Month</span></h1> :
                                            <h1 className="annual"><sup><small>$</small></sup><span className="ff-secondary fw-semibold">171</span> <span
                        ...
                        <Col lg={4}>
                            <Card className="plan-box mb-0 ribbon-box right">
                                <Card.Body className="p-4 m-2">
                                    ...
                                    <div className="py-4 text-center">
                                        {plan ? <h1 className="month"><sup><small>$</small></sup><span className="ff-secondary fw-semibold">29</span> <span
                                            className="fs-13 text-muted">/Month</span></h1> :
                                            <h1 className="annual"><sup><small>$</small></sup><span className="ff-secondary fw-semibold">261</span> <span
                                                className="fs-13 text-muted">/Year</span></h1>}
                                    </div>
                        ...
                        <Col lg={4}>
                            <Card className="plan-box mb-0">
                                <Card.Body className="p-4 m-2">
                                    ...
                                    <div className="py-4 text-center">
                                        {plan ? <h1 className="month"><sup><small>$</small></sup><span className="ff-secondary fw-semibold">39</span> <span
                                            className="fs-13 text-muted">/Month</span></h1> :
                                            <h1 className="annual"><sup><small>$</small></sup><span className="ff-secondary fw-semibold">351</span> <span
                                                className="fs-13 text-muted">/Year</span></h1>}
                                    </div>
