                    ...
                    <Row>
                        <Col lg={8}>
                            <Card>
                                <Card.Body>
                                    <div className="mb-3">
                                        <Form.Label htmlFor="project-title-input">
                                            Project Title
                                        </Form.Label>
                                        <Form.Control
                                            type="text"
                                    ...
                                    <div className="mb-3">
                                        <Form.Label htmlFor="project-thumbnail-img">
                                            Thumbnail Image
                                        </Form.Label>
                                        <Form.Control
                                    ...
                                    <Row>
                                        <Col lg={4}>
                                            <div className="mb-3 mb-lg-0">
                                                <Form.Label htmlFor="choices-priority-input">
                                                    Priority
                                                </Form.Label>
                                                <select
                                        ...
                                        <Col lg={4}>
                                            <div className="mb-3 mb-lg-0">
                                                <Form.Label htmlFor="choices-status-input">
                                                    Status
                                                </Form.Label>
                                                <select
                                                    className="form-select"
                                        ...
                                        <Col lg={4}>
                                            <div>
                                                <Form.Label htmlFor="datepicker-deadline-input">
                                                    Deadline
                                                </Form.Label>
                                                <Flatpickr
                        ...
                        <Col lg={4}>
                            <div className="card">
                                ...
                                <Card.Body>
                                    <div>
                                        <Form.Label htmlFor="choices-privacy-status-input">
                                            Status
                                        </Form.Label>
                                        <select
                                            className="form-select"
                            ...
                            <Card>
                                ...
                                <Card.Body>
                                    <div className="mb-3">
                                        <Form.Label htmlFor="choices-categories-input">
                                            Categories
                                        </Form.Label>
                                        <select
                                            className="form-select"
                                    ...
                                    <div>
                                        <Form.Label htmlFor="choices-text-input">
                                            Skills
                                        </Form.Label>
                                        <Select
                                            value={selectedMulti}
                            ...
                            <Card>
                                ...
                                <Card.Body>
                                    <div className="mb-3">
                                        <Form.Label htmlFor="choices-lead-input">
                                            Team Lead
                                        </Form.Label>
                                        <select
                                            className="form-select"
